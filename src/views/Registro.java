...
public class Registro extends javax.swing.JFrame {
    ...
    public Registro() {
        initComponents();
        setSize(649, 495);//Para que se queden las medidas que le dimos
        setResizable(false);//Para que el usuario no pueda modificar el tamaño.
        setTitle("Registro");//Para colocar un titulo a la ventana
    ...
    private void initComponents() {
        ...
        jLabel1.setText("REGISTRARSE EN UBER");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(113, 71, -1, -1));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 102, 0));
        jLabel2.setText("¿COMO DESEA REGISTRARSE?");
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(253, 149, -1, 108));
...
Registro_Cliente registrarC = new Registro_Cliente();
registrarC.setVisible(true);
this.dispose();// TODO add your handling code here:
    }//GEN-LAST:event_jButton1MouseClicked

    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
Registro_Socio registrarS = new Registro_Socio();
registrarS.setVisible(true);
this.dispose();// TODO add your handling code here:
